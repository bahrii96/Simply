...
function journee_scripts() {
    ...
    wp_localize_script('j-custom', 'ajaxurl',
        array(
            ...
            <table class="wp-list-table widefat striped" style="width: 100%;table-layout: fixed;">
                ...
                <tbody id="the-list">
                    <?php foreach ($results as $item) { ?>
                        <tr>
                            <td class="row_id"><?php if($item->id){echo $item->id;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->name){echo $item->name;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->phone){echo $item->phone;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->email){echo $item->email;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>

                            <td><?php if($item->city){echo $item->city;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->message){echo $item->message;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->page_id){echo get_permalink($item->page_id);}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->attach_id){echo wp_get_attachment_url($item->attach_id);}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>

                            <td><?php if($item->date_added){echo $item->date_added;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                ...
                <tbody id="the-list">
                    <?php foreach ($results as $item) { ?>
                        <tr>
                            ...
                            <td><?php if($item->position){echo $item->position;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->service){echo $item->service;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->details){echo $item->details;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->name){echo $item->name;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->company_name){echo $item->company_name;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->phone){echo $item->phone;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
                            <td><?php if($item->email){echo $item->email;}else{echo "<span style=\"color:#c9c9c9;\">---</span>";} ?></td>
